...
import 'package:swd4_s4/features/social_app/users/register/presntation/controller/cubit.dart';
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<SocialRegisterCubit, SocialRegisterStates>(
        listener: (context, state) {
          if (state is SocialRegisterUserErrorState) {
            showToast(msg: state.error, state: ToastState.error);
          }
          if (state is SocialRegisterUserSuccessState) {
